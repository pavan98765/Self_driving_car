...
const traffic=[
    ...
    new Car(road.getLaneCenter(2),-3800,30,50,"DUMMY",2,getRandomColor()),
    ...
    new Car(road.getLaneCenter(0),-4400,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(1),-4400,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(1),-4600,30,50,"DUMMY",2,getRandomColor()),
    ...
    new Car(road.getLaneCenter(1),-4800,30,50,"DUMMY",2,getRandomColor()),
    ...
    new Car(road.getLaneCenter(0),-5200,30,50,"DUMMY",2,getRandomColor()),
